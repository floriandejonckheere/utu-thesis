...
The categories are based on #cite_full(<bajaj_etal_2021>).
...
For example, #cite_full(<al_debagy_martinek_2020>) propose a data-driven method based on the analysis of the software system's external API, specified in the OpenAPI#footnote[#link("https://www.openapis.org/")[https://www.openapis.org/]] format.
