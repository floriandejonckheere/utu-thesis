...
In this chapter, we present related work on the topic of automated microservice identification in monolith systems, with a focus on concrete implementations of these methods and tools.
A number of tools have been developed to aid the modularization of monolith applications into microservices or modular monolith architecture.
...
Mono2Micro is an AI-based toolchain for the decomposition of monolith applications into microservices, developed by #cite_full(<kalia_etal_2020>).
...
In summary, several tools and frameworks have already been developed to aid the modularization of monolith applications into microservices or modular monolith architecture.
