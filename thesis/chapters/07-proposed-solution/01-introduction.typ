...
In this chapter, we propose *Modular Optimization to Service-oriented Architecture Integration Kit (MOSAIK)*, our solution for identification of microservice candidates in a monolith application.
