...
#cite_full(<mazlami_etal_2017>) propose a microservice extraction model that includes three possible extraction strategies: _logical coupling_ strategy, _semantic coupling_ strategy, and _contributor coupling_ strategy.
...
As #cite_full(<carvalho_etal_2020>) note, the choice of granularity is an important decision in the extraction of microservices.
